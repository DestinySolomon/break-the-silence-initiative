...
const App = () => {
  ...
  return (
    <main className="min-h-screen">
      ...
      <div
        className={`fixed top-0 left-0 w-full z-[60] transition-transform duration-300 translate-y-0 ${scrolled ? "hidden" : ""}`}
      >
        <div className="bg-[#0F2535] text-white/80 text-xs">
          <div className="max-w-7xl mx-auto px-4 md:px-8 h-10 flex items-center justify-between gap-4">
            <div className="flex items-center gap-5 flex-wrap">
              ...
              <a
                href="https://breakthesilenceinitiative.org"
                target="_blank"
      ...
      <nav
        className={`fixed left-0 w-full z-50 transition-all duration-300 ${scrolled ? "top-0 bg-[#1A3A52] shadow-lg py-2" : "top-10 bg-transparent py-4"}`}
      >
        ...
        <div
          className={`md:hidden overflow-hidden transition-all duration-300 bg-white shadow-lg ${mobileMenuOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}
        >
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="w-full lg:w-[40%] flex flex-col gap-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/70 text-sm leading-relaxed">
                        18 Olanrewaju St, Akoka, Lagos 100213,
                        <br />
                        Lagos State, Nigeria
                      </div>
                    </div>
              ...
              <div className="rounded-3xl overflow-hidden h-52">
                <iframe
                  title="SMN Location"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5514.265625939102!2d3.3901942906045446!3d6.534934645045427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xb79ac6db2c10d0b%3A0x625c98acfaf016b8!2sBreak%20The%20Silence%20Initiative%20Nigeria!5e0!3m2!1sen!2sng!4v1776430063374!5m2!1sen!2sng"
                  width="100%"
                  height="100%"
                  allowFullScreen
                  loading="lazy"
        ...
        <div className="border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <p className="text-white/40 text-xs text-center sm:text-right">
              Registered NGO • Akoka, Lagos State, Nigeria
            </p>
          </div>
        </div>
      </footer>
